...
const localStorageFeedbackList = JSON.parse(localStorage.getItem('feedbackList') || '[]');
...
document.getElementById("submitBtn").onclick = function () {
    const newFeedbackName = document.getElementById("input").value;
    const newFeedback = {
        id: getNewId(),
